...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "[",
        function() awful.spawn.with_shell("xrandr --output eDP-1 --brightness 0.5 --output eDP-2 --brightness 0.5") end,
        { description = "show help", group = "awesome" }),
    awful.key({ modkey, "Control" }, "]",
        function() awful.spawn.with_shell("xrandr --output eDP-1 --brightness 1 --output eDP-2 --brightness 1") end,
        { description = "show help", group = "awesome" }),
